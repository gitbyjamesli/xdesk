...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("ID Server", "ID 服务器"),
        ("ID Server cannot be empty", "ID 服务器不能为空"),
        ("Relay Server", "中继服务器"),
        ("Relay Server cannot be empty", "中继服务器不能为空"),
        ("API Server", "API 服务器"),
        ("No history configurations found", "没有历史服务器配置"),
        ("Select server config", "选择服务器配置"),
        ("Add server config", "新建服务器配置"),
